...
import { Box, Grid, KanbanSquare, LayoutGrid, Mail, PanelLeft, Settings2 } from 'lucide-react'
import Link from 'next/link'

export default function FormularioPage() {
  return (
    <ContainerMain header={<Header title="Criação de processo" />} className="p-0 overflow-hidden">
        ...
        <main className="flex-1 bg-gray-50">
          ...
          <div className="p-6  overflow-y-auto">
            ...
            <div className="grid grid-cols-12 gap-6 ">
              ...
              <div className="col-span-3 space-y-4 overflow-y-scroll max-h-[calc(100vh-30vh)]">
