...
import type { DropIndicator, FormComponent, FormComponentType, FormRow } from './types'
import { canAddComponentToRow, createComponent, createRow } from './utils'
        ...
        <div className="md:col-span-9 p-4 overflow-y-auto">
          <div className="flex justify-between items-center mb-4">
            ...
            <Button
              onClick={addRow}
              size="sm"
              className="gap-1 bg-purple-500 hover:bg-purple-600 text-white rounded-sm font-medium px-6"
            >
